  ...
  <span class="sr-only">Toggle navigation</span>
   ...
   <a class="navbar-brand" href="#"><img src="img/i.png" alt="" height="80px" width="300px"></a>
               ...
               <!-- Collect the nav links, forms, and other content for toggling -->
                  ...
                  <li><a href="cart.php"><i class="fa fa-shopping-cart" aria-hidden="true">
 <?php 
echo $total;
?>
</i></a>
...
<li data-filter=".Specials"><a href="">Specials</a></li>
 ...
 <div class="media-body">
          ...
          <a class="read_mor_btn" href="addtocart.php?fid=<?php echo $items['food_id']?>">Add To Cart</a>
